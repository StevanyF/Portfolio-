  ...
  return (
    <div id='home'>
      <nav className="flex justify-center items-center mb-10 ">
        <ul className="flex fixed space-x-4 p-2 sm:p-2 md:p-4 lg:p-4 text-base sm:text-lg md:text-lg lg:text-lg text-white rounded-full border-2 border-lime-200 backdrop-blur-md bg-black/20 shadow-lg z-10 " style={{fontFamily:"Public"}}>
