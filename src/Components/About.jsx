    ...
    <div id='about' className=''>
        <div className='section flex flex-col justify-center items-center mt-20 gap-x-4 '>
            ...
            <div className='box flex flex-col space-y-8 m-10' >
                <div><h1 className='title text-violet-600 uppercase text-6xl font-bold'style={{fontFamily:"Wood"}} >Things about me (3).</h1></div>
                <div className='description space-y-2 w-full text-xl' style={{fontFamily:"Public"}}>
                    ...
                    <p className='border-b-2 border-black p-4'>I like to creat user interface with engaging animations for a memorable user experience</p>
                </div>            
            </div>
        </div>
